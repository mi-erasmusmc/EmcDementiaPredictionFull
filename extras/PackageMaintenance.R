...
#
# This file is part of EmcDementiaPredictionFull
#
...
OhdsiRTools::checkUsagePackage("EmcDementiaPredictionFull")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/EmcDementiaPredictionFull.pdf")
shell("R CMD Rd2pdf ./ --output=extras/EmcDementiaPredictionFull.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "EmcDementiaPredictionFull")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("EmcDementiaPredictionFull")
